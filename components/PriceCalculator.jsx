...
const SERVICES = [
  {
    ...
    extraPageCost: 0.50,
    badge: 'nuevo',
    tooltip: 'Evaluación experta en 6 dimensiones, riesgo de desk-rejection, verificación de citas y recomendación de 4 revistas.',
  },
  {
    id: 'correccion',
    ...
    base: 5,
    unit: 'por página',
    tooltip: 'Corrección ortográfica, gramatical, de estilo académico y coherencia textual.',
  },
  {
    id: 'articulo',
    ...
    pagesIncluded: 25,
    extraPageCost: 8,
    tooltip: 'Manuscrito IMRyD completo con citas verificadas, análisis estadístico y formato de revista.',
  },
  {
    id: 'capitulo',
    ...
    pagesIncluded: 30,
    extraPageCost: 6,
    tooltip: 'Producción de capítulo con rigor científico, citas verificadas y formato editorial.',
  },
  {
    id: 'libro',
    ...
    pagesIncluded: 150,
    extraPageCost: 4,
    tooltip: 'Producción integral de libro académico (5 capítulos). Maquetación, citas verificadas y revisión experta.',
  },
  {
    id: 'revision',
    ...
    pagesIncluded: 40,
    extraPageCost: 8,
    tooltip: 'Revisión de toda la literatura sobre tu tema con protocolo PRISMA. Ideal para tesis de maestría y doctorado.',
  },
  {
    id: 'paquete',
    ...
    extraPageCost: 8,
    badge: 'popular',
    tooltip: 'Tomamos tu borrador y lo convertimos en artículo listo para revista: redacción, formato, cover letter y apoyo con revisores.',
  },
];
